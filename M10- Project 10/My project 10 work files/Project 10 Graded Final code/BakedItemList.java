...
public class BakedItemList { 
  ...
  /**
      ...
      throws FileNotFoundException
   {
      ...
      while (dataScan.hasNext()) { // When there is a next line in the file
         ...
         char category = lineScan.next().charAt(0); // First character on line
         String bakedName = ""; //Name of the item baked
         String flavor = ""; // Flavor of the item baked
         // The quantity of the item baked
         int quantity = 0;
         ...
         // 'C', 'P', 'K', 'W' --> Valid categories
            ...
            case 'P': 
               ...
               // Creating an instance of Cookie class(BakedItem object)
               BakedItem pie = new Pie(bakedName, flavor, quantity, crustCost,
                   ingsPie);
