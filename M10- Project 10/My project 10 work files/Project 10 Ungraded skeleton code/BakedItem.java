...
public abstract class BakedItem implements 
   Comparable<BakedItem> { // Parent class
...
/**
   ...
   /**
      * creating a compareTo method to order two BakedItem objects from 
      * lowest to highest based on name and flavor.
      * @param itemIn for any BkaedItem object
      * @return -1 or 1 or 0 indicating the lowest to highest order
      */
   public int compareTo(BakedItem itemIn) {
      return this.getFlavor().toUpperCase().compareTo(itemIn.getFlavor().toUpperCase()); 
   }
}
